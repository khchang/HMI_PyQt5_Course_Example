...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", " Demo2-3訊號與槽"))
        ...
        self.textEdit.setPlainText(_translate("Dialog", "PyQt5 寫程式指南\n"
"Python 和 Qt"))
        self.btnClear.setText(_translate("Dialog", "清理"))
        self.btnOK.setText(_translate("Dialog", "確 定"))
        self.btnClose.setText(_translate("Dialog", "離開"))
